...
> **"안정적인 아키텍처와 지능적인 서비스의 조화를 고민합니다."** > 트래픽 증가에도 유연하게 대응할 수 있는 구조를 고민하며, 단순한 기능 구현을 넘어 비즈니스 가치를 높이는 백엔드/서버 시스템을 지향합니다. 
...
* **🔍 Focus:** Java & Spring Boot 생태계 기반 서버 개발, RESTful API 및 Microservices Architecture(MSA) 설계
...
<br>
<div align="center">
  <p><strong>🤖 Architecture & AI</strong></p>
...
<br>
<div align="center">
  <p><strong>🛠️ Build, Tools & Collaboration</strong></p>
...
* **CI/CD Pipeline:** GitHub Actions를 활용한 테스트 및 배포 자동화 파이프라인 구축 최적화
...
* **Backend Development:** Spring Boot, Spring Data JPA를 활용하여 각 마이크로서비스의 RESTful API 설계 및 핵심 비즈니스 로직 구현
* **API Documentation:** Swagger UI를 적용하여 프론트엔드 팀과의 효율적인 API 명세 공유 및 협업 진행
...
* **Security & Optimization:** Spring Security를 활용한 인증/인가 처리 및 시스템 안정성 강화 경험
